...
nodes_fw = create_node_df(
  n = length(nodes),
  label = nodes,
  x = c(0, 2, 4.5, 4, 5.9, 1.5, 5.7, 4.5, 5.8, 4.4, 3.8, 1.8, 5.4, 1, 4.6, 5.7,
        1, 5.7, 1, 5.7, 8, 3, 1.4, 3, 1.6),
  y = c(4, 4.5, 4.5, 5.1, 4.4, 6.5, 3.3, 1.5, 1.7, 4, 3.3, 3.6, 6.5, 5.5, 6, 5.4,
        0.7, 0.7, 7, 7, 4, 1, 1.3, 1.8, 2.1),
  style = c('filled', rep('rounded', 19), 'filled', rep('rounded', 4)),
  color = 'gray50',
  fillcolor = c('gray70', rep('white', 19), 'gray70', rep('white', 4)),
  shape = 'rectangle',
  fontcolor = 'black',
  height = 0.1,
  width = 0.3,
