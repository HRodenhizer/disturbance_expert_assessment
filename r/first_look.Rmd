...
demographics = read_excel('data/Demographic Information.xlsx') |>
  mutate(
    across(Gender:`Previous Expert Assessment`, ~ replace_na(.x, 'Not Provided')),
    Category = factor(
      Category,
      levels = c(
        'Anthropogenic',
...
ggplot(gender_count,
       aes(x = Gender, y = Count, fill = Category == 'Total')) +
  geom_col() +
...
ggplot(stage_count,
       aes(x = `Career Stage`, y = Count, fill = Category == 'Total')) +
  geom_col() +
  scale_fill_manual(values = c('gray30', 'black')) +
  facet_wrap(~ Category) +
  theme(legend.position = 'none',
...
ggplot(country_count,
       aes(x = Country, y = Count, fill = Category == 'Total')) +
  geom_col() +
  scale_fill_manual(values = c('gray30', 'black')) +
  facet_wrap(~ Category, ncol = 2) +
  theme(legend.position = 'none',
