...
q1_3_filter_out = unique(
  q1_3_all_notes[
    str_detect(
      q1_3_all_notes, 
      '(O|only)|percentage|exclude|boreal forest of western Canada'
    )
  ]
)
q1_3_filter_out
...
q1_3 = q1_3 |>
  mutate(
    include = case_when(
      Flags %in% q1_3_filter_out ~ FALSE,
      Respondent == 2 & Category == 'Anthropogenic' & Question == '1.0' ~ FALSE, # values are orders of magnitude higher than all others, I'm questioning the units
      TRUE ~ TRUE)
  )
```
