...
q1_3 = q1_3 |>
  mutate(
    across(
      ...
      ~ case_when(Flags %in% q1_3_filter_out ~ NA,
                  Respondent == 2 & Category == 'Anthropogenic' & Question == '1.0' ~ NA, # values are orders of magnitude higher than all others, I'm questioning the units
                  TRUE ~ .)
    )
  )
```
